...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2019 at 05:47 AM
...
('BUS', 'ACCT', 'Accounting', '025468555'),
('ENG', 'CPE', 'Computer', '021111111'),
('f1', 'd1', 'depfoo1', '1'),
('f1', 'd2', 'depfoo2', '2'),
('f2', 'd3', 'depfoo3', '3'),
('f2', 'd4', 'depfoo4', '4'),
('f3', 'd5', 'depfoo5', '5'),
('f4', 'd6', 'depfoo6', '6'),
('BUS', 'ECON', 'Economics', '026665555'),
('ENG', 'IE', 'Industrial Engineering ', '025588777'),
('none', 'none', 'none', 'none');
...
('BUS', 'College of Business', '026455987'),
('ENG', 'College of Engineer', '021457896'),
('f1', 'facfoo1', '1'),
('f2', 'facfoo2', '2'),
('f3', 'facfoo3', '3'),
('f4', 'facfoo4', '4'),
...
('CPE111', 'Data Structure', 3, 'use C & JAVA'),
('CPE231', 'Database', 3, 'use MySQL , MongoDB , Hbase'),
('GEN111', 'Good Man', 3, 'Send some help.'),
('LNG102', 'English For Fun', 2, 'Sneak Sneak Fish Fish'),
('MTH201', 'Mathematics', 2, 'Your calculator can\'t help you anymore.'),
('PHY103', 'Physic For Engineer', 2, 'That\'s ...');
...
(1, 1, '21000.00', '2/2019', 3, 'waiting', '2019-05-22 13:34:08', 'pedusmpqcumfovwrc41y'),
(2, 1, '1000.00', '2/2019', 4, 'waiting', '2019-05-22 14:15:57', 'thyhbtn507cez7clr1cs');
...
(9, 'student1', 'student1@example.com', NULL, '$2y$10$N6P25.X808p1UvzW7ytcbuKK/8H/JD2l0VrmH.k8n4Y1Mi99MN4E2', 1, NULL, '2019-05-22 01:58:38', '2019-05-22 01:58:38'),
(10, 'student2', 'student2@example.com', NULL, '$2y$10$iEo7ONqZ2VkagLVzkL9wweh3LgorINJHJH0uYZgTkisnZNafQIZ7y', 1, NULL, '2019-05-22 01:58:58', '2019-05-22 01:58:58'),
(11, 'student3', 'student3@example.com', NULL, '$2y$10$aXVgZOrev3HNrjgGPAIH6O11iEwJXLQfsR1UaIDPooeMjLMymSSS2', 1, NULL, '2019-05-22 01:59:24', '2019-05-22 01:59:24'),
(12, 'student4', 'student4@example.com', NULL, '$2y$10$yrAoDhJQr5rZqvw0yFsxg.Oj46Y2QVNzPOqmKjdROXYytnoOB9tU.', 1, NULL, '2019-05-22 01:59:51', '2019-05-22 01:59:51'),
(13, 'staff1', 'staff1@example.com', NULL, '$2y$10$LobkcNvquXw5z6.J2AXs5uqqrOGSFwXJh0zRSz86gaKTC8jWdafiW', 3, NULL, '2019-05-22 02:00:19', '2019-05-22 02:00:19'),
(14, 'staff2', 'staff2@example.com', NULL, '$2y$10$ex1n4GEw9ffSWQ33LKsGVu7SHiOuem.OPUHc83upKZ9OGrNqAXv5O', 3, NULL, '2019-05-22 02:01:07', '2019-05-22 02:01:07'),
(15, 'admin', 'admin@example.com', NULL, '$2y$10$Y0BFivkAPtZTNNLglREyfOzFIppsvBBbm.GmxtpuvXEeUoI.tcTl.', 4, NULL, '2019-05-22 02:01:50', '2019-05-22 02:01:50');
...
(10003, 3, 'mr', 'fn3', 'ln3', 'male', 'ab', '2019-05-02', 'r3', 'r3', 'n3', 'a3', 3, 'p3', 'd3', 's3', 'none', '3', NULL),
...
--
ALTER TABLE `sectioneachsubject`
  MODIFY `subjectsectionid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
